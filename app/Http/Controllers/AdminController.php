...
class AdminController extends Controller {
    public function __construct() {
        ...
        // $this->middleware('maintainance', ['except' => ['maintainance']]);
        $this->middleware('login', ['except' => ['index', 'login', 'register', 'faqs', 'terms', 'meetOurTraders', 'howItWorks', 'privacyPolicy', 'aboutUs', 'forgotPass', 'changePass', 'verifyToken']]);
        
        $this->middleware('admin', ['except' => 'quickWithdrawal']);
    }
    ...
    public function index(Request $request){
        ...
        return view('admin.index', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'pending_deposits', 'running_investments', 'total_deposits', 'total_withdrawn', 'total_paid', 'total_users', 'pending_withdrawals', 'currently_invested', 'total_deposited'));
    }
    public function referralBonus(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.referral-bonus', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'users'));
    }
    public function walletBalance(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.wallet-balance', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user','users'));
    }
    ...
    public function currentInvested(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.current-invested', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'users'));
    }
    ...
    public function confirmCredit(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.confirm-credit', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'funds'));
    }
    public function confirmCiCredit(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.confirm-ci-credit', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'funds'));
    }
    ...
    public function confirmDebit(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.confirm-debit', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'funds'));
    }
    public function confirmCiDebit(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.confirm-ci-debit', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'funds'));
    }
    ...
    public function childPlan(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.child-plan', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'parent_plans', 'child_plans'));
    }
    public function parentPlan(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.parent-plan', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'plans'));
    }
    public function files(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.files', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user'));
    }
    public function faqs(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.faqs', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'faqs'));
    }
    public function reviews(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.reviews', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'reviews', 'plans'));
    }
    public function wallets(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.wallets', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'wallets'));
    }
    ...
    public function terms(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.terms', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'terms_and_conditions'));
    }
    public function about(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.about', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'site_about_us'));
    }
    public function privacyPolicy(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.privacy-policy', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'privacy_and_policy'));
    }
    public function meetOurTraders(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.meet-our-traders', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'meet_our_traders'));
    }
    public function howItWorks(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.how-it-works', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'how_it_works'));
    }
    public function quickWithdrawal(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.quickwithdrawal', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user'));
    }
    public function members(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.members', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'users'));
    }
    public function suspendedMembers(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.suspended-members', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'users'));
    }
    public function deniedDeposits(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.denied-deposits', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'deposits'));
    }
    public function approvedDeposits(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.approved-deposits', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'deposits'));
    }
    public function pendingDeposits(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.pending-deposits', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'deposits'));
    }
    ...
    public function deniedWithdrawals(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.denied-withdrawals', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'withdrawals'));
    }
    public function approvedWithdrawals(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.approved-withdrawals', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'withdrawals'));
    }
    public function pendingWithdrawals(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.pending-withdrawals', compact('page_title', 'pending_deposits', 'pending_withdrawals', 'mode', 'user', 'withdrawals'));
    }
    ...
    public function VerifyKyc(Request $request) {
        $user = User::where('id', $request->id)->select(['kyc'])->first();

        if($user->kyc == 'pending') {
            $kyc = User::where('id', $request->id)->update([
                'kyc' => 'verified'
            ]);
            ...
            if($kyc) {
                return response()->json(
                    [
                    'success'=> ['message' => ["User's Kyc verified"]]
                    ], 201
                );
            }
            ...
            return response()->json(
                [
                'error'=> ['message' => ["Error verifying kyc"]]
                ], 401
            );
        }
        ...
        return response()->json(
                    [
                    'error'=> ['message' => ["User's Kyc already verified"]]
                    ], 401
                );
    }
    ...
    public function verifiedKyc(Request $request){
        $page_title = env('SITE_NAME') . " Investment Website";
        $mode = 'dark';
        $user = Auth::user();
        $kycs = Kyc::where('status', 'verified')->get();
        $pending_kyc = Kyc::where('status', 'pending')->count();
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.verified-kyc', compact('page_title', 'pending_kyc', 'mode', 'user', 'kycs', 'pending_deposits', 'pending_withdrawals'));
    }
    ...
    public function rejectedKyc(Request $request){
        ...
        $mode = 'dark';
        $user = Auth::user();
        $kycs = Kyc::where('status', 'rejected')->get();
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.rejected-kyc', compact('page_title', 'kycs', 'mode', 'user', 'pending_deposits', 'pending_withdrawals'));
    }
    ...
    public function pendingKyc(Request $request){
        ...
        $pending_deposits = Deposit::where('status', 'pending')->count();
        $pending_withdrawals = Withdrawal::where('status', 'pending')->count();
        return view('admin.pending-kyc', compact('page_title', 'kycs', 'mode', 'user', 'pending_deposits', 'pending_withdrawals'));
    }
}