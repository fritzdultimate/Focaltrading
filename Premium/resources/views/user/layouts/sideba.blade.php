<div class="l-sidebar sidebar-active">
            <div class="l-sidebar__content" style="background: #053b50;">
                <nav class="c-menu js-menu" id="mynavi">
                    <ul class="d-block px-1 py-4 d-lg-none">
                        <li class="d-flex">
                            <h6 class="text-uppercase">
                                <a href="index.html">WiseFex </a>
                            </h6>
                    ...
                    <ul class="u-list crm_drop_second_ul">
                        ...
                        <li class="c-menu__item is-active has-sub crm_navi_icon_cont">
                            ...
                            <ul>
                                 ...
                                 <li><a href="/user/wallets"><i class="fa fa-circle"></i>wallets</a>
                                 </li>                      
                    ...
                    <ul class="u-list crm_drop_second_ul">
                        ...
                        <li class="c-menu__item is-active has-sub crm_navi_icon_cont">
                            ...
                            <ul>
                                    <li>
                                        <a href="/user/deposit"> <i class="fa fa-circle"></i>make deposit</a>
                                    </li>
                                    <li>
                                        <a href="/user/reinvest"> <i class="fa fa-circle"></i>Reinvest</a>
                                    </li>
                                    <li>
                                        <a href="/user/withdrawal"> <i class="fa fa-circle"></i>Withdrawal</a>
                                    </li>
                    ...
                    <ul class="u-list crm_drop_second_ul">
                        ...
                        <li class="c-menu__item is-active has-sub crm_navi_icon_cont">
                            <a href="javascript:void(0)">
                                <div class="c-menu-item__title"><span>reports</span>
                                </div>
                            </a>
                            <ul>
