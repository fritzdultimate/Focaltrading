...
<div class="app-container">
    ...
    <div class="app-main" id="main">
        ...
        <div class="container-fluid">
                        ...
                        <div class="ml-auto d-flex align-items-center">
                            <nav>
                                <ol class="breadcrumb p-0 m-b-0">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">Withdrawal</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row account-contant" data-wallet="{{ $wallets->count() }}" data-kyc="{{ $user->kyc }}">
                <div class="col-12">
                                ...
                                <div class="border-t col-12">
                                    <div class="page-account-form">
                                        <div class="form-titel border-bottom p-3">
                                            <h5 class="mb-0 py-2">Withdraw Earnings</h5>
                                        </div>
                                        <div class="p-4">
...
@include('user.layouts.general-scripts')
    ...
    <script src="{{ asset('js/user.withdrawal.js?ref=1') }}"></script>
    <!--main js file end-->
</body>
