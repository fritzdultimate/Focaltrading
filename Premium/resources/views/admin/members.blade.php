                        ...
                        <div class="ml-auto d-flex align-items-center">
                            <nav>
                                <ol class="breadcrumb p-0 m-b-0">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">Members</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                                    ...
                                                    <ul class="navbar-nav">
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                @endif
                                                                <a data-action="verifyKyc" data-to="verifyKyc" data-id="{{ $site_user['id'] }}" class="action-link dropdown-item text-capitalize" href="#">Verify KYC</a>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </nav>
...
<script src="{{ asset('js/admin.members.js?ref=4') }}"></script>
</body>
