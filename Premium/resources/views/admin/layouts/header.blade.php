...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('jquery-te/jquery-te.css') }}" />
    <!-- app style -->
                ...
                <nav class="navbar navbar-expand-md">
                    ...
                    <div class="navbar-header d-flex align-items-center">
                        ...
                        <a class="navbar-brand" href="index.html">
                            {{ env('SITE_NAME') }}
                            {{-- <img src="{{ asset('dashboard/assets/img/logo.png') }}" class="img-fluid logo-desktop" alt="logo" /> --}}
                            {{-- <img src="{{ asset('dashboard/assets/img/logo-icon.png') }}" class="img-fluid logo-mobile" alt="logo" /> --}}
                        </a>
                    </div>
