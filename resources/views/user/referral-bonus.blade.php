@include('user.layouts.header')
            ...
            <div class="container">
                <div class="row small">
                    ...
                    <div class="col-xl-9 col-lg-7 col-md-7 col-12 col-sm-7 d-flex align-items-end">
                        <h5 class="text-white static">Manage Referral Bonus</h5>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-12">
                        <div class="sv_heading_wraper">
                            ...
                            <h4 class="text-light">Referral Bonus</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="sv_heading_wraper heading_center mb-3">
                                    ...
                                    <h5 class="text-light">User Referral Bonus : <span class="user-balance">$0.00</span></h5>
                                        ...
                                        <div class="change_pass_field float_left">	
                                            ...
                                            <label>User</label>
                                                ...
                                                <select id="user-list" class="form-control user-list plain" name="name">
                                                    ...
                                                    <option data-balance="{{ $user['referral_bonus'] }}" value="{{ $user['name'] }}">{{ $user['name'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
    ...
    <script src="{{ asset('js/admin.referral-bonus.js') }}"></script>
    <!--main js file end-->
</body>
