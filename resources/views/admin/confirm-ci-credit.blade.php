@include('admin.layouts.header')
            ...
            <div class="container">
                <div class="row small">
                    ...
                    <div class="col-xl-9 col-lg-7 col-md-7 col-12 col-sm-7 d-flex align-items-end">
                        <h5 class="text-white static">Confirm CI credit</h5>
                    </div>
                    <div class="col-xl-3 col-lg-5 col-md-5 col-12 col-sm-5">
                        <div class="sub_title_section">
                            <ul class="sub_title">
                                <li> <a href="#"> Admin </a>&nbsp; / &nbsp; </li>
                                <li>Confirm CI credit</li>
                            </ul>
                        </div>
                    </div>
                </div>
	...
	@include('admin.layouts.sidebar')
         <div class="l-main pt-lg-5 mt-lg-5">             
                                        ...
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <div class="table-responsive">
                                                <table class="record-table table datatables cs-table crm_customer_table_inner_Wrapper">
                                                    <thead>
                                                        <tr>
                                                            <th class="width_table1">Credited By</th>
                                                            <th class="width_table1">To User</th>
                                                        ...
                                                        <tr class="background_white">
                                                            ...
                                                            <td>
                                                                <div class="media cs-media">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <h5>{{ $fund->receiver->name }}</h5>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="pretty p-svg p-curve">${{ $fund['amount'] }}</div>
                                                            </td>
                                                            <td>
                                                                <div class="pretty p-svg p-curve deposit_pending">pending</div>
                                                            </td>
                                                            <td>
                                                                <div class="pretty p-svg p-curve">{{ $fund['created_at'] }}</div>
                                                            </td>
                                                                    ...
                                                                    <ul class="navbar-nav">
                                                                        ...
                                                                        <li class="nav-item dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                <a data-action="approve" data-id="{{ $fund['id'] }}" class="action-link dropdown-item" href="#">Approve</a>
                                                                                <a data-action="deny" data-id="{{ $fund['id'] }}" class="action-link dropdown-item" href="#">Deny</a>                                                                                
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                                </nav>
            ...
            <script src="{{ asset('js/admin.funds.js') }}"></script>
</body>
