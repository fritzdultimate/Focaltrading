                        ...
                        <div class="ml-auto d-flex align-items-center">
                            <nav>
                                <ol class="breadcrumb p-0 m-b-0">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">How It Works</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-statistics">
                        ...
                        <div class="card-body">
                            <form class='page-form settings-form' action="how-it-works">
                                <textarea class="editable w-100" name="how_it_works">{{ $how_it_works }}</textarea>
                                <div>
