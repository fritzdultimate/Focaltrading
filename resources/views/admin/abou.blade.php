            ...
            <div class="container">
                <div class="row small">
                    ...
                    <div class="col-xl-9 col-lg-7 col-md-7 col-12 col-sm-7 d-flex align-items-end">
                        <h5 class="text-white static">About</h5>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-12">
                        <div class="sv_heading_wraper">
                            ...
                            <h4 class="text-light">About Company</h4>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12  p-5 mb-5">
                                <div align="center">
                                    <form class='page-form settings-form' action="about-us">
                                        <textarea class="editable w-100" name="about_us">{{ $site_about_us }}</textarea>
                                        <div>
