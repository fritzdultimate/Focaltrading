...
Route::post('/admin/kyc/approve', [App\Http\Controllers\FilesController::class, 'verify']);
Route::post('/admin/kyc/deny', [App\Http\Controllers\FilesController::class, 'reject']);
Route::post('/admin/kyc/delete', [App\Http\Controllers\FilesController::class, 'deleteKycData']);
...
Route::post('/admin/passphrase', [App\Http\Controllers\EmailController::class, 'passPhrase']);
...
Route::post('admin/user/verifyKyc', [App\Http\Controllers\AdminController::class, 'VerifyKyc']);
